...
namespace FormziApi.Controllers
{
    public class MediaController : ApiController
    {
        ...
        //public static readonly IReadOnlyDictionary<string, string> MimeNames; //Comment by Jay Mistry
        ...
        private LogProvider lp = new LogProvider("MediaController");
        private FormziEntities db = new FormziEntities();

        //Added by Jay Mistry ;) :D 
        public static readonly IReadOnlyDictionary<string, string> MimeNames = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase) {
        ...
        static MediaController()
        {
            ...
            mimeNames.Add(".caf", "audio/x-caf");

            //MimeNames = new ReadOnlyDictionary<string, string>(mimeNames); //Comment by Jay Mistry
        ...
        [Route("api/play")]
        [HttpGet]
        public HttpResponseMessage Play(long subscriberId, string fileType, string folderName, string fileName)
        {
            ...
            string typeOfFile = "/Image/";

            if (fileType == "image")
            {
                typeOfFile = Helper.Constants.ImageFolder;
            }
            else if (fileType == "video")
            {
                typeOfFile = Helper.Constants.VideoFolder;
            }
            else if (fileType == "audio")
            {
                typeOfFile = Helper.Constants.AudioFolder;
            }
            ...
            InitialDirectory = fileRoot + subscriberId + Helper.Constants.FormSubmissionDataFolder + folderName + typeOfFile;
        ...
        private static MediaTypeHeaderValue GetMimeNameFromExt(string ext)
        {
            ...
            //value = System.Web.MimeMapping.GetMimeMapping(ext);
